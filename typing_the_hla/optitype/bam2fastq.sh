...
${java} -Xmx${heap}m  -jar ${picard}/FixMateInformation.jar I=${work_dir}/$1/$2/hlaall.cleaned.bam O=${work_dir}/$1/$2/hlaall.fixed.bam VALIDATION_STRINGENCY=LENIENT
...
${samtools} sort -o -n ${work_dir}/$1/$2/hlaall.fixed.bam $1\_$2 | ${samtools} view - | ${tools_dir}/resolvepairs > ${work_dir}/$1/$2/hlaall.forfastq 2> /dev/null
...
${java} -Xmx${heap}m -jar ${picard}/SamToFastq.jar I=${work_dir}/$1/$2/hlaall.forfastq F=${work_dir}/$1/$2/fastq_for_gz.fastq F2=${work_dir}/$1/$2/fastq_rev_gz.fastq VALIDATION_STRINGENCY=SILENT QUIET=true

rm -rf ${tmp_dir}/$3

rm ${work_dir}/$1/$2/hlaall.srt.bam
rm ${work_dir}/$1/$2/hlaall.cleaned.bam
rm ${work_dir}/$1/$2/hlaall.fixed.bam
rm ${work_dir}/$1/$2/hlaall.forfastq
